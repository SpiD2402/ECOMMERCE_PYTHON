...
class CouponSchema:
    ...
    def create(self):
        return self.namespace.model('Coupon Create',{
            'code':fields.String(required=True,max_length = 50,min_length = 5),
    ...
    def update(self):
        return self.namespace.model('Coupon Update',{
            'code':fields.String(required=False,max_length = 50,min_length = 5),
...
class CouponResponseSchema(SQLAlchemyAutoSchema):
    class Meta:
        model = CouponModel
        ordered = True